    ...
    <footer className="bg-primary text-primary-foreground dark:bg-primary-foreground dark:text-primary pt-24 pb-12 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12 mb-20">
        ...
        <div className="flex gap-4">
          <a href={`mailto:${SITE_DATA.home.social.email}`} className="p-4 bg-white/10 rounded-full hover:bg-white/20 transition-colors backdrop-blur-sm">
              <Mail size={24} />
          </a>
          <a href={SITE_DATA.home.social.twitter} className="p-4 bg-white/10 rounded-full hover:bg-white/20 transition-colors backdrop-blur-sm">
              <Twitter size={24} />
          </a>
          <a href={SITE_DATA.home.social.github} className="p-4 bg-white/10 rounded-full hover:bg-white/20 transition-colors backdrop-blur-sm">
              <Github size={24} />
          </a>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center text-sm text-primary-foreground/40 dark:text-primary/40 gap-4">
        <p>&copy; {new Date().getFullYear()} ZJUSCT. All rights reserved.</p>
      </div>
    </footer>
  );
}